...
export const SEED_DATA_SQL = [
  ...
  `INSERT OR IGNORE INTO home_modules (id, type, title, subtitle, sort_order, status, protected, config) VALUES
    ...
    (6, 'travel', '旅游指南', '来福溪村，感受千年古村的魅力', 6, 'active', 1, '{"cards":[{"icon":"🚗","title":"交通指南","desc":"自驾：永贺高速、国道207、省道203均可到达，距贺州市约1小时车程。铁路：洛湛铁路富川站直达。"},{"icon":"🏠","title":"住宿推荐","desc":"村内有特色民宿可体验古村生活，也可选择富川县城酒店，车程约40分钟。"},{"icon":"🍜","title":"美食推荐","desc":"瑶族油茶、富川三角饺、果条、瑶族腊肉，秋季可品尝富川脐橙和油桃。"},{"icon":"📸","title":"必打卡点","desc":"周敦颐讲学堂（纪念建筑）、爱莲堂、风雨桥、120根木柱古建筑、门楣石雕、青石板古街。"}]}')`
];
